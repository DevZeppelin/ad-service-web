          ...
          <div>
            <section>
              <div className="text-center space-y-6 p-8 md:p-16">
                ...
                <h2 className="text-2xl text-bold">POLITICA DE CALIDAD AD SERVICE</h2>

                <p>AD SERVICE. ES UNA EMPRESA DEDICADA A OFRECER SERVICIOS DE FABRICACION DEHERRAMIENTAS, REPARACION DE EQUIPOS DE BOMBEO, REPARACION DE CONEXIONESPETROLERAS, Y APORTE DURO EN HERRAMIENTAS DE ROTACION EN SU BASE DEOPERACIONES EN LA PROVINCIA DE MENDOZA.</p>
